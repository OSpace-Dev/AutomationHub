...
export interface NotificationChannel { id: string; type: "telegram"; name: string; bot_token_configured: boolean; bot_token_hint: string; proxy_configured: boolean; proxy_url_hint?: string; proxy_enabled: boolean; bot_username?: string; bot_display_name?: string; enabled: boolean; last_verified_at?: string; last_error?: string; created_at: string; updated_at: string; }
export interface TelegramChat { id: string; type: string; title?: string; username?: string; first_name?: string; last_name?: string; already_configured: boolean; }
export interface NotificationTarget { id: string; channel_id: string; name: string; chat_id: string; enabled: boolean; created_at: string; updated_at: string; }
export type ReportDeliveryStatus = "pending" | "sending" | "sent" | "failed";
export interface ReportDelivery { id: string; report_generation_id: string; channel_id: string; channel_name?: string; target_id: string; target_name?: string; chat_id?: string; status: ReportDeliveryStatus; attempt_count: number; message_count?: number; last_error?: string; created_at: string; started_at?: string; sent_at?: string; completed_at?: string; }
