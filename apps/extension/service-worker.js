...
async function handleProjectResult(captureState, result, closeTab = true) {
  ...
  await enqueue({
    ...
    total_stars: Number.isInteger(project.totalStars) ? project.totalStars : undefined,
    stars_today: Number.isInteger(project.starsToday) ? project.starsToday : undefined,
